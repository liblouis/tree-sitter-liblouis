module.exports = grammar({
	...
	space: $ => seq(optional($._prefix), 'space', $._sp, $.char, $._sp, $.dots_with_zero),
	punctuation: $ => seq(optional($._prefix), 'punctuation', $._sp, $.char, $._sp, $.dots_with_zero),
	digit: $ => seq('digit', $._sp, $.number, $._sp, $.dots_with_zero),
	grouping: $ => seq('grouping', $._sp, $.name, $._sp, $.chars, $._sp, $.dots, ',', $.dots),
	base: $ => seq('base', $._sp, $.name, $._sp, $.char, $._sp, $.char),
	letter: $ => seq(optional($._prefix), 'letter', $._sp, $.char, $._sp, $.dots_with_zero_or_equal),
	...
	sign: $ => seq(optional($._prefix), 'sign', $._sp, $.char, $._sp, $.dots_with_zero),
	math: $ => seq(optional($._prefix), 'math', $._sp, $.char, $._sp, $.dots_with_zero),
	...
	endemph: $ => seq(optional($._prefix), 'endemph', $._sp, $.ascii_chars, $._sp, $.dots_with_zero),
	...
	always: $ => seq(optional($._prefix), repeat($.with_class), 'always', $._sp, $.chars, $._sp, $.dots_with_zero_or_equal),
	...
	word: $ => seq(optional($._prefix), repeat($.with_class), 'word', $._sp, $.chars, $._sp, $.dots_with_zero_or_equal),
	...
	midword: $ => seq(optional($._prefix), repeat($.with_class), 'midword', $._sp, $.chars, $._sp, $.dots_with_zero_or_equal),
	...
	postpunc: $ => seq(optional($._prefix), 'postpunc', $._sp, $.chars, $._sp, $.dots_with_zero),
